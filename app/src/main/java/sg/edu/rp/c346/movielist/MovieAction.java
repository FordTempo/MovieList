...
public class MovieAction extends AppCompatActivity {
    TextView tvID;
    EditText etID;
    TextView tvTitle;
    EditText etTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> ratingAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item);
        ratingAdapter.add("G");
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBHelper db = new DBHelper(MovieAction.this);
                ...
                Toast.makeText(MovieAction.this, "Updated " + data.getTitle(),
                        Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(MovieAction.this, MovieList.class);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MovieAction.this, "Removed " + data.getTitle(),
                        Toast.LENGTH_SHORT).show();
